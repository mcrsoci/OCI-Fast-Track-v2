...
Atención: Haga click en la X como indica la imagen
...
```
![SQL](./imagenes/autonomous-database-sql-17a.png)
...
11. Seleccione **Panel de la Base de Datos**.
![selecione "Database Panel"](./imagenes/autonomous-database-service-25.png) 
